...
if (isset($_POST['fix'])){
    ...
    print_r($_SESSION['fix']);
    header("location: modify_drink.php");
                ...
                <nav class="navbar navbar-expand-lg fixed-top nav-menu">
                    ...
                    <div class="collapse navbar-collapse justify-content-end text-uppercase font-weight-bold" id="navbar">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"> <a href="create_drinks.php" class="nav-link m-2 menu">Add Product</a> </li>
                            <li class="nav-item"> <a href="home_admin.php" class="nav-link m-2 menu">Page Admin</a> </li>

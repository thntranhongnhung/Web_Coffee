...
<body>
    ...
    <header>
        ...
        <div class="collapse navbar-collapse justify-content-end text-uppercase font-weight-bold" id="navbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"> <a href="#" class="nav-link m-2 menu">About</a> </li>
                <li class="nav-item"> <a href="#" class="nav-link m-2 menu">Contact</a> </li>
                <li class="nav-item"> <a href="../product.php" class="nav-link m-2 menu">Products</a> </li>

                <li class="nav-item"> <a href="../logout.php" class="nav-link m-2 menu">Log Out </a> </li>
    ...
    <div class ="text-light text-right banner">
        ...
        <p class="main text-center ">Trang quản lý quán coffee</p>
        ...
        <div class="text-center">
            ...
            <a href="create_drinks.php" class="btn btn-warning">Thêm thức uống</a>
            <a href="product.php" class="btn btn-warning">Chỉnh sửa menu</a>                  
            
            <a href="logout.php" class="btn btn-danger">Tạo/ xóa nhân viên</a>
